...
Para configurar a RaspberryPi como UC do modelo de UTA, preparamos unha tarxeta microSD coa última actualización do SO Raspbian, na maneira habitual:
  ...
  * unha vez feita a intalación do SO, configuralo do xeito habitual con 'sudo raspi-config'. Particularmente habilitar o servidor SSH e instalar un servidor VNC a fin de poderse conectar ao equipo en remoto, sen necesidade do monitor.
